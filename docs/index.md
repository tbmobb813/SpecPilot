...
- [Roadmap: Addressing Market Gaps](ROADMAP_MARKET_GAPS.md)
- [Quick Start Guide](QUICKSTART.md)
- [Intelligence Layer](INTELLIGENCE_LAYER.md)
- [Data Sources](DATA_SOURCES.md)
- [Scrapers](SCRAPERS.md)
- [ProtonDB Sync](PROTONDB_SYNC.md)
- [Data Import](DATA_IMPORT.md)
- [Privacy & Telemetry](PRIVACY.md)
- [Contributing](CONTRIBUTING.md)
- [Build Summary](BUILD_SUMMARY.md)
- [Review & Architecture Notes](REVIEW.md)

If you update documentation, please add the new file to this index.
